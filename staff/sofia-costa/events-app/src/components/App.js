  ...
  return (
    <div className="app">
      ...
      {view !== 'login' && view !== 'register' && (
        <Home
          user={user}
          onToPublishEvent={handleGoToPublishEvent}
          onToRetrievePublished={handleRetrievePublished}
          onToRetrieveLast={handleRetrieveLast}
          onToRetrieveSubscribed={handleRetrieveSubscribed}
        />
      )}

      {view === 'publish' && (
        <PublishEvent onSubmit={handleCreateEvent} error={error} />
      )}
